...
export default function Cards(props) {
  const [activePages, getActivePages] = useState(1);

  const setActivepages = (pageNumber) => {
    getActivePages(pageNumber);
  };
    ...
    <>
      <div className="bottom-tabs1">
        <Query
          query={gql`
 {
     schedule(type: ${JSON.stringify(props.type)},status:${JSON.stringify(
            props.status
          )},page:${JSON.stringify(activePages)}){
         matchID
         seriesName
         venue
         startDate
                    ...
                    <div className="bg-white br2">
                      ...
                      <div className="card-body">
                        ...
                        <ul className="card-list">
                          ...
                          <li className="name">{homeTeamName}</li>
                        ...
                        <ul className="card-list">
                          ...
                          <li className="name">{awayTeamName}</li>
                          <li className="datetime">
                            {`${getDate(startDate)[1]}`}
                          </li>
                        </ul>
